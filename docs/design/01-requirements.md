...
| --- | --- | --- | --- |
| Q-1 | 認証は本物のJWTか、簡易ユーザーか | FR-07, NFR-03 | 未定 |
| Q-2 | デモ撮影はiPhoneか（HEIC対応が要るか） | FR-02 | 未定 |
| Q-3 | チーム人数と分担（フロント/バック） | 全体 | 未定 |
| Q-4 | HTTPSトンネルはcloudflaredでよいか | NFR-04.1 | 未定 |
| Q-5 | 「音楽」行は手入力で作るか、削るか | FR-10 | 未定 |

Q-1 と Q-2 は着手前に決める必要がある。残りは 09-26 午前でよい。
